...
if (LINUX)
  ...
  set(CMAKE_CXX_FLAGS_DEBUG "-fno-inline -ggdb ${CMAKE_CXX_FLAGS_DEBUG}")
  set(CMAKE_CXX_FLAGS_RELEASE "-O2 -ggdb ${CMAKE_CXX_FLAGS_RELEASE}")
  #you can take this out later, but I really need debugging symbols right now.
  set(CMAKE_CXX_LINK_FLAGS "-ggdb ${CMAKE_CXX_LINK_FLAGS}")
